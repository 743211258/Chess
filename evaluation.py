...
def eval_to_winrate(score_cp, current_player, k=0.004):
...
board = chess.Board("1Bb3BN/R2Pk2r/1Q5B/4q2R/2bN4/4Q1BK/1p6/1bq1R1rb w - - 0 1")
score = analyze(board)
print(score)
...
print(score)
current_board = chess.Board("1Bb3BN/R2Pk2r/1Q5B/4q2R/2bN4/4Q1BK/1p6/1bq1R1rb w - - 0 1")
print(eval_to_winrate(score, chess.WHITE))
